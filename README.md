...
| :------------------------------------------------ | :---------------------------------------------------------------------------------------------------------- | :------ |
| **[@pokertools/engine](./packages/engine)**       | The immutable core logic for Texas Hold'em state management.                                                | `1.0.9` |
| **[@pokertools/evaluator](./packages/evaluator)** | High-performance hand evaluation and win frequency calculation.                                             | `1.0.9` |
| **[@pokertools/api](./packages/api)**             | Scalable REST & WebSocket API built with Fastify, Redis, and Prisma (SQLite default, PostgreSQL supported). | `1.0.9` |
| **[@pokertools/sdk](./packages/sdk)**             | TypeScript SDK with React hooks and real-time socket management.                                            | `1.0.9` |
| **[@pokertools/admin](./packages/admin)**         | Financial sweeper service, withdrawal processing, and Telegram bot.                                         | `1.0.9` |
| **[@pokertools/types](./packages/types)**         | Shared TypeScript definitions, Zod schemas, and DTOs.                                                       | `1.0.9` |
| **[@pokertools/bench](./packages/bench)**         | Performance benchmarking suite for the engine and evaluator.                                                | `1.0.9` |
| **[@pokertools/e2e](./packages/e2e)**             | Docker-based end-to-end integration tests exercising the full API + blockchain stack.                       | `1.0.9` |
...
GHCR images are published automatically on each [GitHub release](https://github.com/aaurelions/pokertools/releases), tagged as `latest`, `1`, `1.0`, `1.0.9`, and a full commit SHA for every release-triggered build. See [`.github/workflows/docker-publish.yml`](.github/workflows/docker-publish.yml) for details.
